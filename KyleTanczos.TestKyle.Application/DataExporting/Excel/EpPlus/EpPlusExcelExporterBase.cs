...
using KyleTanczos.TestKyle.Net.MimeTypes;
using OfficeOpenXml;

namespace KyleTanczos.TestKyle.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TestKyleServiceBase, ITransientDependency
    {
